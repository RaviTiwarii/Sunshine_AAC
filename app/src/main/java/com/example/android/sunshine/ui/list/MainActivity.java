...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainViewModelFactory viewModelFactory = InjectorUtils.provideMainActivityViewModelFactory(this);
        MainViewModel viewModel = ViewModelProviders.of(this, viewModelFactory).get(MainViewModel.class);
        viewModel.getForecastData().observe(this, weatherEntries -> {
            if (weatherEntries != null) {
                ...
                if (weatherEntries.size() > 0) {
                    //When the Forecast loads, show the weather data view
                    showWeatherDataView();
                } else {
                    //When there is no Forecast, show the loading indicator
                    showLoading();
                }
            }
        });
